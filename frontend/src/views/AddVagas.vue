                            ...
                            <form @submit.prevent="createJob">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="modelo-options py-2">
                                        <div class="form-check" v-for="(option, index) in modeloOptions" :key="index">
                                            <input class="form-check-input" type="radio" :id="option.value"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="tipo-options py-2">
                                        <div class="form-check" v-for="(option, index) in tipoOptions" :key="index">
                                            <input class="form-check-input" type="radio" :id="option.value"
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea rows="4" class="form-control" id="description" v-model="vaga.description"
