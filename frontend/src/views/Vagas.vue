                    ...
                    <div class="grid search">
                        <div class="teste grid-body">
                            <div class="row">
                                    ...
                                    <div class="slider-primary">
                                        <div class="slider slider-horizontal" style="width: 152px;">
                                            ...
                                            <div class="tooltip top hide" style="top: -30px; left: 50.1px;">
                                                ...
                                                data-slider-value="[300,800]" data-slider-tooltip="hide">
                                        </div>
                                    </div> -->
                                    <!-- END FILTER BY PRICE -->
                                </div>
                                ...
                                <!-- BEGIN RESULT -->
                                <div class="col-md-9">
                                    <h2><img width="64px" src="../../public/job-seeker.png" alt=""> Vagas</h2>
                                    <hr>
                                    <!-- BEGIN SEARCH INPUT -->
                                    ...
                                    <!-- END SEARCH INPUT -->
                                    <p>Mostrando todos os resultados correspondentes a "vaga pesquisada "</p>
                                        ...
                                        <table class="table table-hover">
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="image"><img
                                                            src="https://www.bootdey.com/image/400x300/5F9EA0" alt="">
                                                    </td>
                                                    <td class="product"><strong>Product 2</strong><br>This is the
                                                        product description.</td>
                                                    <td class="rate text-right"><span><i class="fa fa-star"></i><i
                                                                class="fa fa-star"></i><i class="fa fa-star"></i><i
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="image"><img src="https://www.bootdey.com/image/400x300"
                                                            alt=""></td>
                                                    <td class="product"><strong>Product 3</strong><br>This is the
                                                        product description.</td>
                                                    <td class="rate text-right"><span><i class="fa fa-star"></i><i
                                                                class="fa fa-star"></i><i class="fa fa-star"></i><i
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="image"><img
                                                            src="https://www.bootdey.com/image/400x300/8A2BE2" alt="">
                                                    </td>
                                                    <td class="product"><strong>Product 4</strong><br>This is the
                                                        product description.</td>
                                                    <td class="rate text-right"><span><i class="fa fa-star"></i><i
                                                                class="fa fa-star"></i><i class="fa fa-star"></i><i
                                                                class="fa fa-star"></i><i
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="image"><img src="https://www.bootdey.com/image/400x300"
                                                            alt=""></td>
                                                    <td class="product"><strong>Product 5</strong><br>This is the
                                                        product description.</td>
                                                    <td class="rate text-right"><span><i class="fa fa-star"></i><i
                                                                class="fa fa-star"></i><i class="fa fa-star"></i><i
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="image"><img
                                                            src="https://www.bootdey.com/image/400x300/6495ED" alt="">
                                                    </td>
                                                    <td class="product"><strong>Product 6</strong><br>This is the
                                                        product description.</td>
                                                    <td class="rate text-right"><span><i class="fa fa-star"></i><i
                                                                class="fa fa-star"></i><i class="fa fa-star"></i><i
                                                                class="fa fa-star"></i><i
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="image"><img
                                                            src="https://www.bootdey.com/image/400x300/DC143C" alt="">
                                                    </td>
                                                    <td class="product"><strong>Product 7</strong><br>This is the
                                                        product description.</td>
                                                    <td class="rate text-right"><span><i class="fa fa-star"></i><i
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="image"><img
                                                            src="https://www.bootdey.com/image/400x300/9932CC" alt="">
                                                    </td>
                                                    <td class="product"><strong>Product 8</strong><br>This is the
                                                        product description.</td>
                                                    <td class="rate text-right"><span><i class="fa fa-star"></i><i
                                                                class="fa fa-star"></i><i class="fa fa-star"></i><i
                                                                class="fa fa-star"></i><i
