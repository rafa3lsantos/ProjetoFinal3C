...
class CurriculumController extends Controller
{
    public function store(Request $request)
    {
        ...
        $rules = [
            ...
            'formation' => 'nullable|string|in:graduação,pos-graduação,mestrado,doutorado',
            'institution' => 'nullable|string|min:3|max:255',
            'experience' => 'nullable|string|min:3|max:255',
            'degree' => 'nullable|string|in:tecnologo,licenciatura,bacharelado',
            'status' => 'nullable|string|in:completo,em andamento,incompleto',
            'course' => 'nullable|string|min:3|max:255',
            'start_date' => 'nullable|date',
            'end_date' => 'nullable|date|after_or_equal:start_date',
            'certificate_type' => 'nullable|string|in:conquista,certificado',
            'certificate_title' => 'nullable|string|min:3|max:255',
            'certificate_description' => 'nullable|string|min:3|max:255',
            'certificate_institution' => 'nullable|string|min:3|max:255',
            'soft_skills' => 'nullable|string|min:3|max:255',
            'hard_skills' => 'nullable|string|min:3|max:255',
            'language' => 'nullable|string|min:3|max:255',
            'language_level' => 'nullable|string|min:3|max:255',
